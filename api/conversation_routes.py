...
async def create_conversation(request: CreateConversationRequest = None):
    ...
    try:
        ...
        conv = get_conversation_manager().create_conversation(title)
        return conv
...
async def conversation_query(conversation_id: str, request: QueryRequest):
    """
