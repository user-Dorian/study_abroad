...
from rag.data_loader.chunk_and_embed import EmbeddingModel, MilvusManager
from rag.retrieval.reranker import Reranker, reranker
...
class RAGRetriever:
    ...
    def _check_data_updates(self):
        ...
        try:
            from rag.data_loader.build_index import RAGDataBuilder
